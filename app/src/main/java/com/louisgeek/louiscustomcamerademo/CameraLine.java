...
public class CameraLine extends View {
    ...
    private void init() {
        ...
        mLinePaint.setColor(Color.parseColor("#FFFF00"));//默认#45e0e0e0
        mLinePaint.setStrokeWidth(10);//默认1dp
        mLinePaint.setStrokeCap(Paint.Cap.ROUND);

        mLineCrossPaint = new Paint();
        mLineCrossPaint.setColor(Color.parseColor("#55000000"));//00-FF
        mLineCrossPaint.setStrokeWidth(Utils.dip2px(getContext(), 3));//默认1dp
